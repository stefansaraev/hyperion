...
///
/// The AmlogicWrapper uses an instance of the AmlogicFrameGrabber to obtain ImageRgb's from the
...
public:
	///
	/// Constructs the Amlogic frame grabber with a specified grab size and update rate.
	///
	...
	///
	/// Destructor of this Amlogic frame grabber. Releases any claimed resources.
	///
